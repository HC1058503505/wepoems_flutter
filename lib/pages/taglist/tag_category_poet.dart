...
class _TagCategoryPoetState extends State<TagCategoryPoet> with AutomaticKeepAliveClientMixin {
      ...
      child: Stack(
        ...
        children: <Widget>[
          ...
          Container(
            ...
            width: 40,
            height: (widget.authors.length + 1) * 30.0,
            child: ListView(
              ...
              children: widget.authors.map<Widget>((author){
                ...
                return GestureDetector(
                  onTap: (){
                    ...
                    _scrollController.animateTo(50.0 * temp, duration: Duration(milliseconds: 250), curve: Curves.decelerate);
                  },
                  child: Container(
                    alignment: Alignment.center,
    ...
    for (PoemTagAuthor author in widget.authors) {
      Widget titleWidget = SliverToBoxAdapter(
        child: Container(
          ...
          height: 50,
          color: Colors.black.withAlpha(10),
          child: Text(author.title, style: TextStyle(fontSize: 18.0, fontWeight: FontWeight.bold),),
      ...
      SliverFixedExtentList extentList = SliverFixedExtentList(delegate: SliverChildListDelegate(author.list.map<Widget>((authorItem){
        return GestureDetector(
          onTap: (){
              ...
              children: <Widget>[
                Expanded(
                  child: Container(
                    child: Padding(
                      padding: EdgeInsets.only(left: 20),
                      child: Text(authorItem.poet_name, style: TextStyle(fontSize: 16),),
                    ),
                  ),
                ),
                Expanded(
                ...
                Expanded(
                  child: Container(
                    child: Padding(
                      ...
                      child: Text(authorItem.poetry_count + "首", style: TextStyle(fontSize: 16),),
                    ),
                  ),
                )
              ],
